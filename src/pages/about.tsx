    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          title: `${t('pages.about.title', { ns: 'seo' })}`,
          description: `${t('pages.about.meta_description', { ns: 'seo' })}`,
          images: [
            {
              url: `https://www.pointsyncc.com/api/page-og-1200x630?title=${t('pages.about.title', { ns: 'seo' })}&description=${t('pages.about.meta_description', { ns: 'seo' })}`,
              width: 1200,
              height: 630,
              alt: `${t('pages.about.title', { ns: 'seo' })}`,
              type: 'image/jpeg',
            }
          ],
          siteName: 'POINTSYNCC',
