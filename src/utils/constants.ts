...
export const PHONE_REGEX = /^\+[1-9]{1,2}[0-9]{1,10}$/;


//COMPANY DATA
export const COMPANY_ADDRESS = 'Zavrtnica 17, 10000 Zagreb, Croatia'
export const COMPANY_CONTACT_EMAIL = 'info@pointsyncc.com'
